...
vis_dir = joinpath(AquariumClosed.VIS_DIR, "poiseuille_flow")
mkpath(vis_dir)
...
save_file = joinpath(AquariumClosed.DATA_DIR, "poiseuille_flow.jld2")
jldsave(save_file;
...
data = load(joinpath(AquariumClosed.DATA_DIR, "poiseuille_flow.jld2"))
